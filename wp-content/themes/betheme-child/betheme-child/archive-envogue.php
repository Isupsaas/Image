<?php
/**
 * The Template for displaying EnVouges list
 *
 * @package Betheme
 * @author M.Mounir
...
<div id="Content">
    ...
    <div id="Filters" class="column one">
        <ul class="filters_buttons">
            <li class="srSearchWrapper"><i class="icon-search"></i><input type="text" class="quicksearch" placeholder="En Vouge Search"></input></li>
        </ul>
        </div>
    </div>
                    ...
                    <div class="column one column_blog">
                        <div class="blog_wrapper isotope_wrapper">
							 <div class="posts_group lm_wrapper masonry tiles col-5 isotope">
								...
								<?php
									$args = array( 'post_type' => 'envogue', 'posts_per_page' => -1 );
